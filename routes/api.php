...
Route::get('/fns/detections02', [FnsDetectionController::class, 'index02']);
...
Route::get('/master-alert-summary/dashboard/{warehouseNmsId?}', [MasterAlertController::class, 'dashboardApi'])
    ->where('warehouseNmsId', '[0-9]+');
