...
.login-left{
    ...
    url('https://images.unsplash.com/photo-1664382953403-fc1ac77073a0?q=80&w=1172&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
    ...
    <div class="login-right">
        ...
        <div class="login-box">
            ...
            <div class="logo">
                ...
                <div >
                    <img src="{{asset('8689634.png')}}" alt="Logo"style="width: 80px; height: 80px;">
                </div>
